...
for indice, precio in enumerate(precios):
    if precio < 20:
        print(F' El indice del producto es {indice} y tiene el precio de {precio}')
    elif precio >=20 and precio <=30:
        print(F'El indice del producto es {indice} y tiene el precio de {precio-(precio*0.1)}')
    elif precio >30:
        print(F'El indice del producto es {indice} y tiene el precio de {precio-(precio*descuenti)}')
...
numeros_4=[4, 8, 15, 16, 23, 42]

for numero_4 in numeros_4:
    if numero_4 % 2==0 and  numero_4 % 3==0:
        print(f'El número {numero_4} es dividible entre 2 y 3 ')
        break
    elif numero_4 % 2==0:
        print(f'El número {numero_4} es divisible entre 2')
        continue
    elif numero_4 % 2 != 0 and numero_4 % 3 != 0:
        print(f'El número  {numero_4}es divisible entre 3')
    else:
        pass
...
while dinero_inicial >=compra:
      ...
      print(f'Producto comprado, tu dinero restante es : {dinero_inicial}' )
...
# 4.Usando un bucle "while", una variable 'indice' que empiesa en 0, representa el numero de la iteracion, y aumenta en 1 cada ietración recorre la lista "nombres" y realiza las siguientes acciones:
...
while indice <= len(nombres) - 1:
    ...
    indice = indice + 1
if encontrado == False:
    print('Nombre del amado no encontrado')