...
ultimo_producto=compras.pop(-1)
print(compras)
print(ultimo_producto)
print(f'El último elemento de la última borrado y almacenado es: {ultimo_producto}')


# 7.Imprime la longitud de la lista usando "len()".

longuitud_lista=len(compras)
print(longuitud_lista)
