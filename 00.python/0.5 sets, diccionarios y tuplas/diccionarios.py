...
#No pueden aparecer elementos con claves repetidas al igual que un diccionario en la vida real.
...
import  copy                                # y modificas la lista en la copia también se modifica la lista en el diccionario original.
...
copia_profunda = copy.deepcopy(tecnologias) #Copia profunda de un diccionario, ahora no apuntan a la misma zona de memoria
